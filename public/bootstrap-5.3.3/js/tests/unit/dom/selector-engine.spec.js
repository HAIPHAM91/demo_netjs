...
describe('SelectorEngine', () => {
  ...
  describe('getElementFromSelector', () => {
    it('should get element from data-bs-target', () => {
      ...
      expect(SelectorEngine.getElementFromSelector(testEl)).toEqual(
  ...
  describe('getMultipleElementsFromSelector', () => {
    it('should get elements from data-bs-target', () => {
      ...
      expect(SelectorEngine.getMultipleElementsFromSelector(testEl)).toEqual(
        Array.from(fixtureEl.querySelectorAll('.target')),
      );
    });
    ...
    it('should return empty array if elements not found', () => {
      ...
      expect(SelectorEngine.getMultipleElementsFromSelector(testEl)).toHaveSize(
        0,
      );
    });
